                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 mx-auto card pt-50">
                        <div class="form-contact contact_form">
                          <form  action="{{route('editeyy',$pengaduan->id)}}"  method="post" enctype="multipart/form-data" >
                           {{ csrf_field() }}
                            {{ method_field('POST') }}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <input class="form-control" name="judul" id="subject" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Subject'" placeholder="Enter Subject" value="{{$pengaduan->judul}}" required>
                                      ...
                                      <script src="{{asset('assets/ckeditor/ckeditor.js')}}"></script>
                                       ...
                                       <style>
                                          #cke_1_contents{
                                            ...
                                            <textarea name="isi_laporan" id="editor1" rows="10" cols="80" >
                                                {{$pengaduan->isi_laporan}}
                                            </textarea><br>
                                             <select name="kategori" id="" data-placeholder="Category ..." class="standardSelect form-control col-md-12" tabindex="1" >
                                                <option  label="Category" selected="">{{$pengaduan->kategori}}</option>
                                ...
                                <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                  <div class="card-body">
                                   <div class="row">
                                       ...
                                       <div class="col-lg-6 ">
                                           <img src="{{asset('upload/'.$pengaduan->foto)}}" id="profile-img-tag" class="float-right" alt="" width="200px">
                                       </div>
                                   </div>
                                  </div>
                                </div>
                            ...
                            <div class="form-group mt-3">
                                <label for="submit" class="button button-contactForm boxed-btn">Send</label>
                                <button type="submit" id="submit" onclick="confirm('are you sure?')" hidden="" ></button>
                            </div>
                          </form>  
                        </div>
                    </div>
